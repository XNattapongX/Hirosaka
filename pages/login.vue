<template>
    ...
    <div class="w-full max-w-md space-y-8">
        <div>
        <img class="mx-auto h-30 w-auto" src="https://i.etsystatic.com/20510423/r/il/ff569f/3829290969/il_fullxfull.3829290969_gwhw.jpg" alt="Your Company">
        <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Nattapong Manga Shop</h2>
        </div>
